...
2. **Clone this repository.** - `git clone https://github.com/talmukund/dbatz.git` or [download the zip](https://github.com/talmukund/dbatz/archive/master.zip)
3. **Make sure you're in the directory you just created.** - `cd dbatz`
...
6. Use path.resolve on all path references in both the dev and prod webpack.config. [See this commit](https://github.com/talmukund/dbatz/commit/298848d4332d3bec9eb4e23592e710083acaf340) for an example.
